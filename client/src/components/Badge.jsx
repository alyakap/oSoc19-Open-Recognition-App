...
const Badge = props => {
  ...
  return (
  <>
  <div className="view jarallax" data-jarallax={{speed: 0.2}} style={{backgroundImage: 'url(' + BgImgae  + ')',backgroundRepeat: 'no-repeat', backgroundSize: 'cover',backgroundPosition:'center' }}>
